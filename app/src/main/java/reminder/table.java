...
public class table {
    ...
    public static void tableScreen(ArrayList<reminder> arrayReminders, int x) throws InterruptedException{
...
public static ArrayList<reminder> addReminders(){
    ...
    // then creates an object with a title,duration,and completion that the user inputted
